# Contributing to AWS Secrets Manager Terraform Module
...
Examples:
```
feat(secrets): add support for rotation configuration
fix(kms): correct KMS key reference handling
...
- Prefix resources with module name: `aws_secretsmanager_secret.this`
